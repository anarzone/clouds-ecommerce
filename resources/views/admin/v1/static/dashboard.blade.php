...
@section('unique-js')
    ...
    <script src="{{asset('admin/js/jquery.flot.categories.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin/js/curvedlines.js')}}" type="text/javascript"></script>
    <script src="{{asset('admin/js/jquery.flot.tooltip.min.js')}}" type="text/javascript"></script>

    <script src="{{asset('admin/js/chartist.js')}}" type="text/javascript"></script>
    ...
    <script src="{{asset('admin/js/light.js')}}" type="text/javascript"></script>
    <script type="text/javascript" src="{{asset('admin/js/custom-dashboard.min.js')}}"></script>
@endsection
